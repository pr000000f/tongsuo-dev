...
__owur int tls13_generate_master_secret(SSL_CONNECTION *s, unsigned char *out,
                                        ...
                                        size_t *secret_size);
__owur int tls1_export_keying_material(SSL_CONNECTION *s, unsigned char *out, size_t olen,
                                       const char *label, size_t llen,
                                       const unsigned char *p, size_t plen,
                                       int use_context);
__owur int tls13_export_keying_material(SSL_CONNECTION *s, unsigned char *out, size_t olen,
                                        const char *label, size_t llen,
...
__owur SSL_TICKET_STATUS tls_get_ticket_from_client(SSL_CONNECTION *s, CLIENTHELLO_MSG *hello,
                                                    SSL_SESSION **ret);
