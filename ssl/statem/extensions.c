                          ...
                          unsigned int thisctx)
{
    ...
    if ((SSL_CONNECTION_IS_DTLS(s)
            ...
            /*
             * Note that SSL_CONNECTION_IS_DTLS() means "TLS 1.3 has been negotiated",
...
#ifndef OPENSSL_NO_CERT_COMPRESSION
EXT_RETURN tls_construct_compress_cert(SSL_CONNECTION *s, WPACKET *pkt,
                                       unsigned int context,
                                       X509 *x, size_t chainidx)
{
    int i;
...
int tls_parse_compress_cert(SSL_CONNECTION *s, PACKET *pkt, unsigned int context,
                            X509 *x, size_t chainidx)
{
    unsigned int id;
    CERT_COMP *comp = NULL;
