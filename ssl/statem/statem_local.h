...
EXT_RETURN tls_construct_ctos_psk_kex_modes(SSL_CONNECTION *s, WPACKET *pkt,
                                            unsigned int context, X509 *x,
                                            size_t chainidx);
EXT_RETURN tls_construct_ctos_cookie(SSL_CONNECTION *s, WPACKET *pkt, unsigned int context,
                                     X509 *x, size_t chainidx);
...
__owur EXT_RETURN tls_construct_compress_cert(SSL_CONNECTION *s, WPACKET *pkt,
                                              unsigned int context,
                                              X509 *x, size_t chainidx);
...
__owur MSG_PROCESS_RETURN tls_process_compressed_certificate(SSL_CONNECTION *s,
                                                         PACKET *pkt,
                                                         profunc_f profunc);
__owur MSG_PROCESS_RETURN tls_process_client_compressed_certificate(SSL_CONNECTION *s,
                                                                PACKET *pkt);
__owur MSG_PROCESS_RETURN tls_process_server_compressed_certificate(SSL_CONNECTION *s,
                                                                PACKET *pkt);
#endif
